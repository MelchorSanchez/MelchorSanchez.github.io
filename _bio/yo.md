...
position1: "Associate Manager Data Science | Data Product Analytics"
...
So 1 year and almost 3 months after starting as a freelancer I returned to the business world by joining [Zifo](https://www.zifornd.com) in December 2022 as a Senior Consultant in Cheminformatics, and I became Team Lead in Cheminformatics in October 2023. In January 2025 I took over the Informatics team in Europe (previously split into Cheminformatics and Bioinformatics) together with the Data Science team, focused on AI applications. Since April 2025 I am an Associate Manager leading the Data Product Analytics team in Europe, which encompasses Scientific Informatics (Cheminformatics and Bioinformatics) and AI applications, as well as data strategy, data analysis, and data product development (from ideation to deployement). Zifo is a company that helps science-driven organisations innovate through a full range of specialised scientific computing services. It is a role where science, people and data products meet, and I am having fun with the challenge.


Last but not least, since 2015, I also collaborate with the [Universitat Oberta de Catalunya](https://www.uoc.edu), a private university based in Barcelona, in the [M.Sc. program in Bioinformatics and Biostatistics](https://estudios.uoc.edu/es/masters-universitarios/bioinformatica-bioestadistica/presentacion), teaching [Programming for Bioinformatics](http://cv.uoc.edu/tren/trenacc/web/GAT_EXP.PLANDOCENTE?any_academico=20252&cod_asignatura=M0.152&idioma=CAS&pagina=PD_PREV_PORTAL&cache=S) as well as directing and evaluating M.Sc. thesis.  I also love teaching, helping people learn and at the same time [communicating knowledge (another of my passions)](/static/pdf/outreach.pdf). I really enjoy teaching!
